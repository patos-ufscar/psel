...
let s:cpo_save=&cpo
set cpo&vim
inoremap <C-@>  " handle terminals that send <Nul> for ctrl+space
inoremap <Nul>  " handle terminals that send <Nul> for ctrl+space
inoremap <C-Space> 
nnoremap  :Vex!
...
silent only
silent tabonly
cd ~/Documents/bcc/patos/load-balancer
